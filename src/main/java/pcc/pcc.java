...
public class pcc {
	...
	public CompleteGraph calculPcc() {
		...
		//Intersection inter7 = new Intersection(new Long(7), 3.0, 1.0, l1);
		Segment s1 = new Segment(1.0, "", inter1, inter2);
		Segment s2 = new Segment(2.0, "", inter2, inter4);
		Segment s3 = new Segment(5.0, "", inter1, inter3);
		Segment s4 = new Segment(1.0, "", inter3, inter4);
		Segment s4a = new Segment(1.0, "", inter4, inter3);
		Segment s5 = new Segment(5.0, "", inter4, inter5);
		Segment s6 = new Segment(6.0, "", inter3, inter6);
		Segment s7 = new Segment(2.0, "", inter5, inter6);	
		Segment s7a = new Segment(2.0, "", inter6, inter5);	
		Segment s8 = new Segment(4.0, "", inter1, inter6);	
		inter1.addOutboundSegment(s1);
		inter1.addOutboundSegment(s3);
		//inter1.addOutboundSegment(s8);
