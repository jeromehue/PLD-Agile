...
/**
 * Receives interesting events from the mouse and calls the controller to update
 * data and view.
 * 
 * @author H4414
...
public class MouseListener extends MouseAdapter {
	...
	/**
	 * The controller of the application that this notifies of the actions performed
	 * with the mouse.
	 */
	...
	/**
	 * Invoked by mouseClicked to determine the point whose coordinates are those of
	 * the mouse cursor.
	 * 
	 * @param evt The mouse event that was performed by the user.
