...
public class Pcc {
	 ...
	 * 
	 * @param city    Objects who contains intersections and segments to make a map.
	 * @param request Objects who contains specific intersections and informations
	 *                to create a tour.
	 */
	 ...
	 * 
	 * @return Object CompleteGraph with costs to go from an intersection to
	 *         another.
	 */
	...
	/**
	 * Computes the Dijkstra algorithm between the <code>start</code> vertex and all
	 * vertices of <code>startVertices</code> The results are stored in
	 * <code>allVerticesPcc</code> and <code>savePredecessors</code>.
	 * 
	 * @param startVertices The list of Intersection needed to compute the
	 *                      algorithm.
	 * @param start         The Intersection from which we search the shortest paths
	 *                      to all other Intersections.
	 * @param verticesPcc   HashMap linking an intersection's id to its instance of
	 *                      IntersectionPcc, needed for this algorithm.
	 */
	 ...
	 * 
	 * @param start  Beginning of the list of segments.
	 * @param finish Beginning of the list of segments.
	 * @return A list of segments which represent the shortest way to go from start
	 *         to finish.
	 */
	...
	/**
	 * 
	 * @return An integer which represents the number of seconds needed to travel
	 ...
	 * modifications.
	 * 
	 * @param interList List of intersections representing the tour.
	 * @return A list of ways which contain all the segments to run the tour and
	 *         some informations about time spent on each step.
	 */
	...
	/**
	 * Enables the modifying of the position of an intersection - it's not possible
	 * to change the position of the starting point.
	 * 
	 * @param tour         Contains the current order between pick up and delivery
	 *                     points.
	 * @param intersection The intersection to change.
	 * @param shift        Integer which represents the shift in the order. Can be
	 *                     positive or negative.
	 * @return A new Tour updated.
	 */
	...
	/**
	 * Enable to add a request to the tour. It adds a pickup and a delivery point at
	 * a specific index.
	 * 
	 * @param tour             Contains the current order between pick up and
	 *                         delivery points.
	 * @param pickup           The pickup intersection to add.
	 * @param delivery         The delivery intersection to add.
	 * @param pickUpDuration   Time spent in seconds at pick up point.
	 * @param deliveryDuration Time spent in seconds at delivery point.
	 * @param pickupIndex      Index where the pick up point will be added.
	 * @param deliveryIndex    Index where the delivery point will be added.
	 * @return A new Tour updated.
	 */
	 ...
	 * @param tour         Contains the current order between pick up and delivery
	 *                     points.
	 * @param intersection The step to delete.
	 * @return A new Tour updated.
	 */
	 ...
	 * 
	 * @param velocity The new bike velocity in m.s-1.
	 */
