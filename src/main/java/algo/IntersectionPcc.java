...
/**
 * This class is an extension of the class Intersection made especially for the
 * Dijkstra algorithm. It stores the same informations as an Intersection, with
 * a <code>color</code> as an Integer and a <code>cost</code> as a Double. It is
 * also Comparable to other IntersectionPcc.
 * 
 * @author H4414
 *
 */
public class IntersectionPcc extends Intersection implements Comparable<IntersectionPcc> {
	...
	/**
	 * In the instance of a Dijkstra algorithm, it is the lowest known cost needed
	 * to go from the starting point to this.
	 */
	private Double cost;
