...
public class Tour extends Observable {
	...
	private HashMap<Long, Boolean> isPositionConsistent; // Id Intersection, isPositionConsistent (pickUp before
															// Delivery)
	...
	public void updateIsPositionConsistent(Long idInterToCheck) {
		...
		if (request.getStartingLocation().getId().equals(idInterToCheck)) {
			...
			do {
				...
				/*
				 * else { System.out.println("[Tour.update] currentInter is null..."); }
				 */
