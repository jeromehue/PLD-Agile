...
/**
 * This class contains the informations relative to a Tour. A Tour contains all
 * the informations needed for the delivery man to complete his duties, from
 * start to end. This Tour has been generated by the TSP algorithm to be as
 * optimal as possible. After the user changes it manually, the tour cannot be
...
public class Tour extends Observable {
	/**
	 * The Intersection from which the delivery man will leave and at which he will
	 * return at the end of his tour.
	 */
	...
	/**
	 * The list of ways linking all steps of the tour, as computed by the TSP
	 * algorithm to be as optimal as possible. It can be edited by the user.
	 */
	private List<Way> waysList;

	/**
	 * HashMap linking an Intersection to a boolean, which is false if the
	 * corresponding intersection is a delivery placed before its corresponding
	 * pick-up in the order of the tour, else true.
	 * 
	 */
	private HashMap<Long, Boolean> isPositionConsistent;

	/**
	 * Constructor used to initialize all fields of this Tour. The HashMap is
	 * initialized by iterating over the waysList and the request.
	 * 
	...
	/**
	 * Constructor used to initialize some fields of this Tour. Only the request is
	 * being initialized.
	 * 
	 * @param request All informations given by the user about this tour.
	 */
	...
	/**
	 * Empty constructor. Used by the controller to initialize a Tour when no
	 * informations is available about it yet.
	 */
	public Tour() {
	...
	/**
	 * Used by the constructors to initialize the HashMap isPositionConsistent.
	 */
	 ...
	 * Default setter.
	 * 
	 * @param waysList Used to initialize this wayList when it has been computed by
	 *                 Pcc.java.
	 */
	...
	/**
	 * Used to retrieve an iterator on the list of ways. Especially useful to
	 * display all ways on the map.
	 * 
	 ...
	 * Default getter.
	 * 
	 * @return The request containing all informations about this tour that were
	 *         given by the user.
	 */
	 ...
	 * Default getter.
	 * 
	 * @return The HashMap used to check if a delivery point is placed before its
	 *         corresponding pick-up point in this tour.
	 */
	 ...
	 * checking if a delivery point is placed before its corresponding pick-up point
	 * in this tour.
	 * 
	 * @param idInterToCheck The id of the intersection that was modified in the
	 *                       tour.
	 */
	...
	/**
	 * Used to know if an intersection is a delivery point being placed before its
	 * corresponding pick-up point in this tour.
	 * 
	 * @param idIntersection The id of the intersection to check.
	 * @return False if the given intersection is a delivery point placed before its
	 *         corresponding pick-up point in this tour, else true.
	 */
	 ...
	 * 
	 * @param idIntersection The intersection for which we would like to know the
